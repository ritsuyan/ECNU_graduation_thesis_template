...
% diy by im0qianqian
\def\thesisTitle{智能网联汽车威胁模型设计与攻击仿真实验研究}
\def\thesisTitleNoWrap{智能网联汽车威胁模型设计与攻击仿真实验研究}
\def\thesisETitle{
  Design of Intelligent Networked Vehicle Threat Model and Research on External Intrusion Detection
}
