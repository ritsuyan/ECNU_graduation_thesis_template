...
% diy by im0qianqian
\def\thesisTitle{智能网联汽车安全模型风险评估方法设计及实现}
\def\thesisTitleNoWrap{智能网联汽车安全模型风险评估方法设计及实现}
\def\thesisETitle{
    Design and Implementation of Risk Assessment Method for Intelligent Networked Vehicle Safety Model
}
